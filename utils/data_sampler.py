...
class InfiniteBatchSampler(Sampler):
    ...
    def gener_indices(self):
        ...
        # Python 内置 list/tuple 在 DataLoader 逐项 collate 时比 np.ndarray 更快。
...
class DistInfiniteBatchSampler(InfiniteBatchSampler):
    ...
    def gener_indices(self):
        global_max_p = self.iters_per_ep * self.glb_batch_size  # glb_batch_size 可被 world_size 整除，因此 global_max_p 也可被整除
